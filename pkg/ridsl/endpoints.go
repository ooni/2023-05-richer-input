...
//
// The returned [Func] type is: [DNSLookupResultType] -> [ListOfEndpointType].
...
//
// 2. the composed function input type is not [EndpointType];
//
// 3. the composed function output type is not [VoidType].
//
// The returned [Func] type is: [ListOfEndpointType] -> [VoidType].
