...
// httpsDomainTarget is the target for https-domain.
type httpsDomainTarget struct {
...
func (c *httpsDomainTarget) tlsHandshakeOptions() (out []dslx.TLSHandshakeOption, err error) {
