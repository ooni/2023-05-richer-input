...
//
// Minimal implementation of [Runtime] and [Trace]
//
...
// MinimalRuntime is the minimal [Runtime]. This [Runtime] mostly does not do anything
...
// NewMinimalRuntime creates a new [MinimalRuntime].
